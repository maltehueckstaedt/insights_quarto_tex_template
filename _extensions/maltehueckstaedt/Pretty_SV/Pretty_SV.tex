...
\begin{center}
  {\fontspec{calibrib}[Path = {_extensions/maltehueckstaedt/Pretty_SV/Calibri/}]\color{sv_blue}\huge{\Huge\MakeUppercase{\@title}}} \\ \vspace{0.3cm}
...
\setmainfont[
  Path = _extensions/maltehueckstaedt/Pretty_SV/Calibri/,
...
% Überschriften
\titleformat{\section}{\fontspec{calibrib}[Path = {_extensions/maltehueckstaedt/Pretty_SV/Calibri/}]\huge\color{sv_blue}}{\thesection}{1em}{}
\titleformat{\subsection}{\fontspec{calibrib}[Path = {_extensions/maltehueckstaedt/Pretty_SV/Calibri/}]\Large\color{sv_blue}}{\thesection}{1em}{}
\titleformat{\subsubsection}{\fontspec{calibrib}[Path = {_extensions/maltehueckstaedt/Pretty_SV/Calibri/}]\large\color{sv_blue}}{\thesection}{1em}{}
\titleformat{\paragraph}{\fontspec{calibrib}[Path = {_extensions/maltehueckstaedt/Pretty_SV/Calibri/}]\normalsize\color{sv_blue}}{\thesection}{1em}{}
...
\AtPageUpperLeft{% 
    ...
    \put(\LenToUnit{.5\dimexpr\paperwidth-2.7cm\relax},-3cm){% 
        \color{sv_red}\includegraphics[width=2.5cm]{_extensions/maltehueckstaedt/Pretty_SV/svlog.png}
      }%
 }%
}
